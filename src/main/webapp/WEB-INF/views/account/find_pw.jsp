						...
						<div class="column width-12 center">
							<div class="title-container">
								<div class="title-container-inner text-black">
									<h4 class="title-medium mb-30">비밀번호 찾기</h4>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="signup-form-container">
									<div class="row bord-b-1">	
										...
										<div class="column width-10">
											<div class="field-wrapper">
												<input type="text" name="fname" class="form-fname form-element rounded small" placeholder="" tabindex="1" required="">
											</div>
										</div>
									</div>
									<div class="row bord-b-1">	
									...
									<div class="row text-center">	
										<div class="column width-12">
											<input type="submit" value="비밀번호찾기" class="form-submit button rounded large bkg-theme bkg-hover-green color-white color-hover-white">
										</div>	
									</div>
								</div>
							</div>
